...
setwd("C:/Users/isabe/OneDrive/Georgia/School/MIIS/Spring/Advanced Data Analysis/practice/wvs")
...
# The first four columns are categories. Eliminate them before analyzing.
mydata <- WVS2015[, 5:430]

# On second examination, there are a lot of categorical and binary values. Use this to eliminate all but scale and interval
#     variables. 
...
# The data set is considerably smaller now, but we can work with these.
...
```{r}
Nfacs <- 43  #  You can change this as needed.
